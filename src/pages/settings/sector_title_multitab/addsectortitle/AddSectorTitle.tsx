...
const AddSectorTitle = () => {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        if (!title.trim()) {
            setModal({ isOpen: true, title: "Required", message: "Title is required" });
            return;
        }
        ...
        try {
            ...
            setModal({
                isOpen: true,
                title: "Error",
                message: error.message || "Failed to save sector title ❌"
            });
        } finally {
            setSaving(false);
        }
    ...
    const handleEdit = (item: MultitabTitle) => {
        ...
        // Note: description doesn't exist in master table yet, keeping as placeholder
    ...
    const handleDelete = async (id: number) => {
        if (window.confirm("Are you sure you want to delete this title?")) {
            try {
                ...
                setModal({ isOpen: true, title: "Deleted", message: "Deleted successfully ✅" });
                fetchTitles();
            } catch (error) {
        ...
        <div className="page-container">
            ...
            <form className="form-card" onSubmit={handleSave}>
                <div className="form-header">
                    <h2>{editingId ? "Edit Sector Title" : "Add Sector Title"}</h2>
                    <p className="subtitle">
                        Create a separate list of sector titles for settings page use
                    </p>
                </div>
