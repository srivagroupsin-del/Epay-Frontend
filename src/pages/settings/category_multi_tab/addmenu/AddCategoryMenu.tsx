...
} from "../../../../api/multitab/category_menu.api";
...
const AddCategoryMenu = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (form.id) {
                await updateMenu(form.id, payload as any);
    ...
    return (
        <div className="container">
            <h2 className="page-title">
                {form.id ? "Edit Category Multi Tab Menu" : "Add Category Multi Tab Menu"}
            </h2>
            <hr />
            ...
            <form onSubmit={handleSubmit}>
                <div className="merged-container">
                    ...
                    <div className="input-floating-group" style={{ flex: "1 1 300px" }}>
                        <label>Category Multi Tab Menu</label>
                        <input
                            type="text"
                            value={form.name}
                            onChange={(e) =>
                ...
                <div className="btn-row">
                    ...
                    <button
                        ...
                        onClick={() => setForm({ id: null, name: "", status: "active" })}
                    >
                        Cancel
                    </button>
                </div>
            ...
            <div className="table-card">
                <div className="table-header">
                    <h3>View Category Multi Tab Menu List</h3>
                                ...
                                <tr key={m.id}>
                                    ...
                                    <td>
                                        <div className="action-buttons">
                                            ...
                                            <button className="action delete" onClick={() => handleDelete(m.id)}>
                                                <Trash2 size={16} />
                                            </button>
                                        </div>
                                    </td>
