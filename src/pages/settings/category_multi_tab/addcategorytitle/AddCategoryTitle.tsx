...
const AddCategoryTitle = () => {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            ...
            alert(error.message || "Failed to save category title ❌");
        } finally {
            setSaving(false);
        }
    };
        ...
        <div className="page-container">
            <form className="form-card" onSubmit={handleSave}>
                <div className="form-header">
                    <h2>{editingId ? "Edit Category Title" : "Add Category Title"}</h2>
                    <p className="subtitle">
                        Create a separate list of category titles for settings page use
                    </p>
                </div>
            ...
            <div className="form-card" style={{ marginTop: "30px", maxWidth: "100%" }}>
                <div className="form-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div>
                        <h2>View Category Title List</h2>
                    </div>
