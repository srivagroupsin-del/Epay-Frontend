...
import { getCheckboxes, createCheckbox, updateCheckbox, deleteCheckbox } from "../../../../api/multitab/brand_checkbox.api";
import type { Checkbox as BrandCheckboxMaster } from "../../../../api/multitab/brand_checkbox.api";

const AddBrandCheckboxMaster = () => {
    ...
    const handleEditClick = (cb: BrandCheckboxMaster) => {
        setEditingId(cb.id);
        ...
        <div className="checkbox-page-container">
            ...
            <div className="checkbox-form-card">
                <div className="checkbox-form-header">
                    <h2>{editingId ? "Edit Brand Checkbox Master" : "Add Checkbox Master"}</h2>
                </div>
            ...
            <div className="checkbox-table-card">
                <div className="checkbox-table-header">
                    <h2>View Brand Checkbox Master List</h2>
...
export default AddBrandCheckboxMaster;
