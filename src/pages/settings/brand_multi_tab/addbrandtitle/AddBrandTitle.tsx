...
import { createMultitabTitle, deleteMultitabTitle, getMultitabTitles, updateMultitabTitle, type MultitabTitle } from "../../../../api/multitab/title.api";
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (editingId) {
                ...
                alert("Brand Title updated successfully ✅");
            } else {
                await createMultitabTitle(payload);
                alert("Brand Title saved successfully ✅");
            }
            ...
            alert(error.message || "Failed to save brand title ❌");
        } finally {
            setSaving(false);
        }
    };
        ...
        <div className="page-container">
            <form className="form-card" onSubmit={handleSave}>
                <div className="form-header">
                    <h2>{editingId ? "Edit Brand Title" : "Add Brand Title"}</h2>
                    <p className="subtitle">
                        Create a separate list of brand titles for settings page use
                    </p>
                </div>
