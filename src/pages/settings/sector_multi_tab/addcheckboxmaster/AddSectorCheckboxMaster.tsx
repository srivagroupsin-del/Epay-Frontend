...
import { Plus, SquarePen, Trash2, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, Check } from "lucide-react";
        ...
        <div className="checkbox-page-container">
            ...
            <div className="checkbox-form-card">
                <div className="checkbox-form-header">
                    <h2>{editingId ? "Edit Sector Checkbox Master" : "Add Checkbox Master"}</h2>
                </div>
