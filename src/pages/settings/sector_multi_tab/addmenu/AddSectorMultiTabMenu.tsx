...
const AddSectorMultiTabMenu = () => {
    ...
    return (
        <div className="container">
            <h2 className="page-title">{form.id ? "Edit Sector Multi Tab Menu" : "Add Sector Multi Tab Menu"}</h2>
            <hr />

            <form onSubmit={handleSave}>
                <div className="merged-container">
                    <div className="input-floating-group" style={{ flex: "1 1 400px" }}>
                        <label>Sector Multi Tab Menu</label>
                        <input
                            type="text"
                            value={form.name}
                                    ...
                                    <td>
                                        <div className="action-buttons">
                                            <button className="action edit" onClick={() => {
                                                setForm({ id: m.id, name: m.name, status: m.status });
